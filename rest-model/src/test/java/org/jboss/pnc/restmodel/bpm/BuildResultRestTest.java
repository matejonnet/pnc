...
public class BuildResultRestTest {
    ...
    public void shouldGetLimitedToStringWithSomeValues() {
        ...
        EnvironmentDriverResult environmentDriverResult = new EnvironmentDriverResult(CompletionStatus.SUCCESS, Optional.empty());
        buildResultRest.setEnvironmentDriverResult(environmentDriverResult);

        buildResultRest.setRepourResult(new RepourResult(CompletionStatus.SUCCESS,"org.jboss", "1.1.0.Final-redhat-1"));
